import XCTest
// @testable import Cleanlink // Uncomment when added to Xcode target

final class CleanlinkParserTests: XCTestCase {
    
    func testInstagramValidURLWithIgsh() {
        let input = "https://www.instagram.com/reel/DCEi_TQpISD/?igsh=MnN5Z3Bkczh1ZDFm"
        let result = CleanlinkParser.clean(urlString: input)
